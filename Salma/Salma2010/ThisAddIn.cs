...
namespace Salma2010
{
    ...
    public partial class ThisAddIn
    {
        ...
        {
            int count = (from control in this.Application.ActiveDocument.ContentControls.OfType<ContentControl>()
                         where Application.Selection.InRange(control.Range)
        ...
        public void AddWIControl(int wiID, string wiFieldName, Range range = null)
        {
            ...
            AddVariables(wiID, wiFieldName, newControl.ID);
        }
        ...
        private void AddVariables(int wiID, string wiFieldName, string controlID)
        {
            try
            {
                Microsoft.TeamFoundation.WorkItemTracking.Client.WorkItem wItem = TfsManager.Instance.GetWorkItem(wiID);

                this.Application.ActiveDocument.Variables.Add(controlID + "_wiid", wiID);
                this.Application.ActiveDocument.Variables.Add(controlID + "_wifield", wiFieldName);
                this.Application.ActiveDocument.Variables.Add(controlID + "_wirev", wItem.Rev);
            }
            catch { }
        }
        ...
        /// </summary>
        /// <param name="controlID"></param>
        private void DeleteVariables(string controlID)
        {
            try
            {
                this.Application.ActiveDocument.Variables[controlID + "_wiid"].Delete();
                this.Application.ActiveDocument.Variables[controlID + "_wifield"].Delete();
                this.Application.ActiveDocument.Variables[controlID + "_wirev"].Delete();
            }
            catch { }
        }
