...
LangString DESC_SEC03 ${LANG_ENGLISH} "TFS Object Model"
...
LangString DESC_SEC03 ${LANG_RUSSIAN} "TFS Object Model"
...
LangString DESC_SEC03 ${LANG_UKRAINIAN} "TFS Object Model"
...
LangString TFS_NAME ${LANG_ENGLISH} "TFS Object Model"
LangString TFS_NAME ${LANG_RUSSIAN} "TFS Object Model"
LangString TFS_NAME ${LANG_UKRAINIAN} "TFS Object Model"
...
Var "DOTNET_RETURN_CODE"
	...
	Section "$(TFS_NAME) $(NOT_INSTALLED)" SEC03		
	${If} $IfTfsObjectModelChecked == 1				
		File tfs_ObjectModel.exe
		ClearErrors
		DetailPrint "$(INSTALLING_TFS_OBJECT_MODEL)" 
		nsExec::ExecToStack "tfs_ObjectModel.exe /s"
		ClearErrors
		DetailPrint "$(INSTALLED_TFS_OBJECT_MODEL)"
		DetailPrint "$(REMOVING_TEMPORARIES)" 
		IfErrors 0 +2
				Call RollBackAndAbort
		Delete "$INSTDIR\tfs_ObjectModel.exe"
	${EndIf}		
	SectionEnd
...
Function CheckComponentSectionGroup
	...
	Call CheckTFSObjectModelInstalled
...
Function CheckTFSObjectModelInstalled
ReadRegStr $0 HKLM "SOFTWARE\Microsoft\TeamFoundationServer\12.0\InstalledComponents\ObjectModel" "Installed"
	StrCpy $IfTfsObjectModelChecked 1
	${If} $0 == "1"
		SectionSetText ${SEC03} "$(TFS_NAME) $(INSTALLED)"
		SectionSetFlags ${SEC03} 17
		SectionSetSize ${SEC03} 0
		;!insertmacro UnselectSection ${SEC03}
		StrCpy $IfTfsObjectModelChecked 0	
	${EndIf}	
FunctionEnd

Function CheckSectionGroupIfHasComponents
	${If} $IfTfsObjectModelChecked == 0
	${AndIf} $IfVstoRuntimeChecked == 0
